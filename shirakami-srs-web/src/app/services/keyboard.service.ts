/* tslint:disable */
// Keyboard Shortcuts service by Ben Nadel
// Many thanks Ben!
// Small alterations made, mostly to satisfy the linter gods.
...
export type KeyboardUnlisten = () => void;
...
export class KeyboardService {
    ...
    public listen(
        ...
        const listener = this.addListener({
            ...
            terminalWhitelist: this.normalizeTerminalWhitelist(
                options.terminalWhitelist
            ),
        ...
        for (const listener of this.listeners) {
            if ((handler = listener.bindings[key])) {
                ...
                if (!isInputEvent || listener.inputs) {
                    ...
                    const result = this.zone.runGuarded((): boolean | void => {
            ...
            if (
                ...
                !listener.terminalWhitelist[key]
            ) {
                return;
            }
        } // END: For-loop.
    ...
    private normalizeTerminalWhitelist(
